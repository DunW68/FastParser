...
class ArticleRequests:
    ...
    def create_record(self, article: schemas.ArticleParserBase):
        article = models.Article(header=article.header, text=article.text)
...
class ArticleImagesRequests:
    ...
    def create_record(self, article_image: schemas.ArticleImage, article_id):
        article_image = models.ImageUrls(page_url=article_image.page_url, image_url=article_image.image_url,
